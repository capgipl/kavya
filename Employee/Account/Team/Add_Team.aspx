...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div style="height:100%" class="panel panel-default" >
     ...
     <tr  style="height:100%;margin:20%">
         <td><asp:Label runat="server" class="control-label col-sm-2" ID="lblteamid" Text="Team Id"></asp:Label></td>
         <td><asp:TextBox runat="server" class="col-xs-3" ID="txtteamid" CssClass="form-control" TextMode="Number"></asp:TextBox></td>
     </tr>
     <tr style="height:100%;margin:20%">
         <td><asp:Label runat="server" class="control-label col-sm-2" ID="Lblteamname" Text="Team Name"></asp:Label></td>
         <td><asp:TextBox runat="server"  class="col-xs-3" CssClass="form-control" ID="txtteamname"></asp:TextBox></td>
     </tr>
     <tr style="height:100%;margin:20%">
         <td style="width:40%"><asp:Label class="control-label col-sm-2" Width="20%" runat="server" ID="lblhg" Text="Home Ground"></asp:Label></td>
     ...
     <tr>
       <td></td>
         <td style="margin:100%"><asp:Button runat="server" class="btn btn-primary"  Text="Submit"/>
